...
import BtnMobilePhone from "./BtnMobilePhone.js";
      ...
      <section className={classes["main-section"]}>
        ...
        >
          ...
          <p className={classes["main-section__instalare-text"]}>
            ...
            predispuse la eșec, motiv pentru care montarea este importantă
            pentru noi.
            <br /> Tehnicienii noștri sunt familiarizați cu toate specificațiile
            producătorului și știm cum să ne asigurăm pentru ca fiecare sistem
            pe care îl instalăm să îndeplinească aceste specificații.
            <br /> Echipa noastră de instalare poate face aproape întotdeauna
            treaba într-o singură vizită și, dacă există probleme, îl informăm
            în permanență pe proprietar.{" "}
          </p>
        </div>
        <div className={classes["main-section__wrapper-title"]}>
